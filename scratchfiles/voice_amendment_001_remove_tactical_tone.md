...
The Members page renders these labels for `account\_tenants.status`:
...
Brain Ratification — Postscript

Date: 2026-05-05 | Session: Product Trio Brain Review | Status: RATIFIED

The following decisions override the draft defaults in this document:

Q1 — Status labels: Option B ratified. Replace display labels as follows:
...
Surfaces \& Navigation — "Live Now": Override ratified. Replace with "Riding Now" (not "Live Now" as written in the dictionary table above).

All other dictionary entries and implementation instructions execute as written. Q2 and Q3 execute per The Hands' stated defaults.
...
|V1.0.0|2026-05-05|Final|Sr PM + The Brain|
