...
Pending (not yet done): Porkbun zone export (Neil) — until it lands, acceptance criterion 2 of W294 (full record set exported) is a documented gap, and the `vechelon.ca` apex record type is unconfirmed; decisions S1/S5/S7/S9; Maps referrer list; Play-hold confirmation; Cloudflare account choice.
